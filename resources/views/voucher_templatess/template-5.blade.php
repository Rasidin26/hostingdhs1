...
.username {
    ...
    font-weight: 700;
    font-size: 32px;
    color: #000;   /* 🔹 ganti jadi item (hitam) */
    z-index: 2;
}
...
@media print {
    ...
    .username { font-size: 12px; color: #000 !important; }
    .validity { font-size: 9px; color: #000 !important; }
    .num { font-size: 8px; color: #000 !important; }
}
</style>
</head>
<body>
